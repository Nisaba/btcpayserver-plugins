...
- **1.4.6** - New icon for dark mode, add ZCash at checkout (Select it in the Exolix configuration page so that it is active at checkout), fix the link to the transaction json view in the customers swap list, small improvements
